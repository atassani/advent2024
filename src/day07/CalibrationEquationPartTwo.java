...
public class CalibrationEquationPartTwo {
    private final long testValue;
    private final List<Long> numbers;


    public CalibrationEquationPartTwo(String line) {
    ...
    private boolean isValidHelper(long currentResult, int index) {
        ...
        return isValidHelper(currentResult + nextNumber, index + 1) ||
               ...
               isValidHelper(Long.parseLong(currentResult + String.valueOf(nextNumber)), index + 1);
    }
